  ...
  return (
    <section id="contact" className="py-20 px-4 bg-muted/30">
      <div className="container mx-auto max-w-6xl">
        ...
        >
          <h2 className="text-4xl font-bold text-foreground mb-4">Contáctame</h2>
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  {isSubmitted ? (
                    <motion.div
                      ...
                      className="p-4 bg-green-100 dark:bg-green-900/30 text-green-800 dark:text-green-200 rounded-lg text-center font-medium"
                    >
